...
def recognise():
	...
	while True:
		...
		for face in faces:
			...
			id, confidence = recognizer.predict(gray[y:y+h,x:x+w]) # gray portion of the face
			...
			cv2.putText(frame,"PRESS 'ESC' TO EXIT", (10, 320), font, 1, (0,255,0), 1)
			...
			if FLAG:
				cv2.putText(frame, "Real", (x+7,y+h+20), font, 1, (255,255,255), 1 )
			else:
				cv2.putText(frame, "Fake", (x+7,y+h+20), font, 1, (255,255,255), 1 )
